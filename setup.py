...
setup(
  name = 'wmc',         # How you named your package folder (MyLib)
  packages = ['wmc'],   # Chose the same as "name"
  ...
  url = 'https://github.com/kushagra27/wmc',   # Provide either the link to your github or to your website
